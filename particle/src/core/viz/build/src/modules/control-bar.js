...
function addStyles() {
    // Styles now in styles.css -- no-op to avoid duplicate injection
}
...
export { init, toggle, show, hide, applyMapping, resetMapping, createGroupFromSelection, removeGroup, dispose };
