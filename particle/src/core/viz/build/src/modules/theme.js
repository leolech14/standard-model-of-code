...
function setTheme(themeName) {
    ...
    // Wireframe mode: scientific-paper theme uses wireframe node rendering
    const isWireframe = themeName === 'scientific-paper';
    document.documentElement.setAttribute('data-appearance-mode', isWireframe ? 'wireframe' : 'filled');

    // Notify holarchy view if it exists
    if (window.HOLARCHY && typeof window.HOLARCHY.updateTheme === 'function') {
        window.HOLARCHY.updateTheme(themeName);
    }
