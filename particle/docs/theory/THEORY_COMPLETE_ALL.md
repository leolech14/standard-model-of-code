...
This file contains **100% of the Standard Model of Code theory** in reading order:

1. **L0: AXIOMS** (867 lines) - Foundational truths
2. **L1: DEFINITIONS** (871 lines) - What exists
3. **L2: LAWS** (828 lines) - How things behave
4. **L3: APPLICATIONS** (810 lines) - How to measure

**New Additions (2026-01-28):**
- Compositional Alignment Law [95% validated] → L2 §7
- Code Entanglement Law [78% validated] → L2 §8
- API Definition [78% validated] → L1 §9.1
- Dual Navigation Spaces [75% validated] → L1 §9.2

All additions include epistemic parentheses showing validation confidence.

---

## Reading Strategy

**Sequential (4-6 hours):** Read L0 → L1 → L2 → L3 in order
**Reference:** Jump to specific sections as needed
**Quick scan:** Skim headers to understand structure
...
**Research reports:**
- `docs/research/theories/SESSION_2026-01-28_CONSOLIDATED_FINDINGS.md`
- 6 Perplexity research reports (300+ academic citations)
- Empirical studies + formal models

---

**BEGIN COMPLETE THEORY:**
...
**Terminology:** `../../../wave/docs/GLOSSARY.yaml` (122 terms)
