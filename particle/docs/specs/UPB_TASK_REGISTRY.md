...
```
STEP 1: Create file
   mkdir -p particle/src/core/viz/assets/modules/upb
   touch particle/src/core/viz/assets/modules/upb/scales.js
...
```
STEP 1: Create file
   touch particle/src/core/viz/assets/modules/upb/endpoints.js
...
STEP 1: Create presets directory
   mkdir -p particle/src/core/viz/assets/modules/upb/presets
...
```
STEP 1: Create file
   touch particle/src/core/viz/assets/modules/upb/bindings.js
...
```
STEP 1: Create file
   touch particle/src/core/viz/assets/modules/upb/blenders.js
...
```
STEP 1: Create file
   touch particle/src/core/viz/assets/modules/upb/index.js
