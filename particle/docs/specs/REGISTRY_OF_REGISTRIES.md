...
- **[Contextome](../../../wave/docs/CONTEXTOME.md)**: Documentation/AI context universe
...
| **[ROR](file://particle/docs/specs/REGISTRY_OF_REGISTRIES.md)** | **Structural Index** | Meta-index of all plural collections and taxonomies. | Power Set (P(U)) |
| **[SOS](file://particle/docs/specs/FRONTEND_SUBSYSTEM_REGISTRY.md)** | **Functional Anatomy** | Biological/Physiological mapping of subsystems. | Partition (P) |
...
| **Docs Reorg** | **ARCHIVED** | `wave/docs/DOCS_REORG_TASK_REGISTRY.md` | 7/10 done |
...
| Registry | Count | Location | Description |
|----------|-------|----------|-------------|
| **Analysis Sets** | **17+** | `wave/config/analysis_sets.yaml` | brain, body, viz, complete, etc. |
| **Prompts** | **14+** | `wave/config/prompts.yaml` | claims_ledger, lens_validation, dimension_orthogonality, etc. |
| **Semantic Models** | **varies** | `wave/config/semantic_models.yaml` | AI model configs |
...
| File | Purpose | Location |
|------|---------|----------|
| `pipeline.py` | Pipeline Orchestrator | `wave/tools/refinery/` |
| `refinery.py` | Logistics-aware Chunker | `wave/tools/ai/aci/` |
| `corpus_inventory.py` | Ingestion Scanner | `wave/tools/refinery/` |
