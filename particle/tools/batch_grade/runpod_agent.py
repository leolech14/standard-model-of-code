...
BATCH_CONFIG = {
    ...
    "github_repo": "https://github.com/leolech14/particle.git",
}

# Script to run inside the pod
# Note: Repo structure is PROJECT_elements/particle/tools/batch_grade/
...
# The actual collider code is inside particle/
cd particle
