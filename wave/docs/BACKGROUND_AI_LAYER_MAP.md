...
║   │                                                                          │ ║
║   │   .agent/intelligence/          wave/reports/              │ ║
║   │   ├── truths/                   └── socratic_audit_*.md                  │ ║
║   │   ├── confidence_reports/                                                │ ║
║   │   ├── centripetal_scans/        particle/docs/research/   │ ║
...
**Status:** IMPLEMENTED | **Spec:** `wave/docs/HOLOGRAPHIC_SOCRATIC_LAYER.md`
...
│                                                             │
│   Output: wave/reports/socratic_audit_*.md   │
└────────────────────────────────────────────────────────────┘
```
...
| Tool | Purpose | Command |
|------|---------|---------|
| `analyze.py --verify` | Run domain audit | `python wave/tools/ai/analyze.py --verify pipeline` |
...
**Status:** IMPLEMENTED | **Tool:** `wave/tools/ai/aci/refinery.py`
...
| Tool | Purpose | Command |
|------|---------|---------|
| `refinery.py` | CLI for atomization | `python wave/tools/ai/aci/refinery.py <file_or_dir>` |
...
Docs: `wave/docs/RESEARCH_SCHEMAS.md`
Engine: `wave/tools/ai/aci/research_orchestrator.py`
...
python wave/tools/ai/analyze.py --verify pipeline \
    --candidate particle/src/core/full_analysis.py
```
...
| `wave/docs/HOLOGRAPHIC_SOCRATIC_LAYER.md` | HSL spec |
| `wave/docs/RESEARCH_SCHEMAS.md` | Research Schema orchestration |
