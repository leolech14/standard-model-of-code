...
| Doc | Purpose |
|-----|---------|
| `../../particle/docs/specs/CODOME_COMPLETENESS_INDEX.md` | Measurement formulas |
| `../../particle/docs/specs/CODOME_HEALTH_INDEX.md` | Health scoring |
| `../../particle/docs/specs/CODOME_BOUNDARY_DEFINITION.md` | Inclusion/exclusion rules |
| `../../particle/docs/specs/CODOME_LANDSCAPE.md` | Topology visualization |
...
- `particle/docs/COLLIDER.md` — Analysis tool
