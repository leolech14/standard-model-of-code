...
>
> **OCTAHEDRAL SHAPE:** Each atom is geometrically represented as an **octahedron** with 8 triangular faces—one for each dimension. *(Legacy visualization archived in `particle/.archive/docs_archive/legacy_theory/`)*
