...
<dict>
    ...
    <array>
        ...
        <string>/Users/lech/PROJECTS_all/PROJECT_elements/wave/tools/drift_guard.py</string>
        <string>--once</string>
    </array>
...
/Users/lech/PROJECTS_all/PROJECT_elements/.tools_venv/bin/python \
  /Users/lech/PROJECTS_all/PROJECT_elements/wave/tools/drift_guard.py --once
```
...
- Test manually: `GEMINI_API_KEY="..." python wave/tools/drift_guard.py --once`

### Missing dependencies
- Ensure `.tools_venv` is activated and dependencies installed
- Run: `pip install -e .` from `particle/`
...
- Drift Guard: `wave/tools/drift_guard.py`
- Analysis tool: `wave/tools/ai/analyze.py`
- State file: `wave/intelligence/drift_guard_state.json`
