...
| Document | Purpose |
|----------|---------|
| [THEORY_AXIOMS.md](particle/docs/theory/THEORY_AXIOMS.md) | Formal mathematical axioms (A1-H5) |
| [PROJECTOME.md](wave/docs/PROJECTOME.md) | Universe algebra: P = C ⊔ X |
| [CODOME.md](wave/docs/CODOME.md) | Executable code definition |
| [CONTEXTOME.md](wave/docs/CONTEXTOME.md) | Non-executable content definition |
| [GLOSSARY.md](wave/docs/GLOSSARY.md) | 400+ terms, canonical vocabulary |
...
| Document | Purpose |
|----------|---------|
| [MODEL.md](particle/docs/MODEL.md) | **THE** Standard Model of Code |
| [COLLIDER.md](particle/docs/COLLIDER.md) | The analysis tool reference |
| [TOPOLOGY_MAP.md](wave/docs/TOPOLOGY_MAP.md) | Spatial model of the repository |
...
| [AI_USER_GUIDE.md](wave/docs/deep/AI_USER_GUIDE.md) | The three AI roles |
| [CLI_GRAMMAR.md](wave/docs/agent_school/CLI_GRAMMAR.md) | ./pe command reference |

### 5. REGISTRIES (Tier 3 - Indices)

| Registry | Purpose |
|----------|---------|
| [REGISTRY_OF_REGISTRIES.md](particle/docs/specs/REGISTRY_OF_REGISTRIES.md) | Master index of all registries |
...
| [OPEN_CONCERNS.md](particle/docs/OPEN_CONCERNS.md) | Active issues & tech debt |
...
|-------|------|-------------|---------|
| **PARTICLE** | `particle/` | [CLAUDE.md](particle/CLAUDE.md) | Collider engine |
| **WAVE** | `wave/` | [AI_USER_GUIDE.md](wave/docs/deep/AI_USER_GUIDE.md) | AI tools |
...
| Calibration data | [artifacts/INDEX.md](particle/artifacts/INDEX.md) | TBD |
| Schemas | [schema/REGISTRY.md](particle/schema/REGISTRY.md) | TBD |
