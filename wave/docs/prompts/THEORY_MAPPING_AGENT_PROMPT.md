...
| Main project | `/particle/` |
| CLI entry | `/particle/cli.py` |
| Core engine | `/particle/src/core/` |
| Theory docs | `/particle/docs/theory/` |
| Schema (fixed) | `/particle/schema/fixed/` |
| Schema (learned) | `/particle/schema/learned/` |
| Crosswalks | `/particle/schema/crosswalks/` |
| Tests | `/particle/tests/` |
| Roadmap | `/particle/ROADMAP.md` |
| Validation prompts | `/particle/docs/prompts/` |
