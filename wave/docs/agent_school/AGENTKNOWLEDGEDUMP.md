...
|-------|-----------|--------------|----------|
| **Particle** | `particle/` | Measurement, collapse, certainty | Collider engine, atoms, schemas |
| **Wave** | `wave/` | Potential, field, possibility | AI tools, research, planning |
...
| Sync to GCS | `python wave/tools/archive/archive.py mirror` |
