...
|------------|------|---------|
| **Body** | `particle/` | Collider engine — parses and analyzes code |
| **Brain** | `wave/` | AI tools, cloud sync, orchestration |
...
```bash
python wave/tools/ai/analyze.py "your question" --set <SET_NAME>
```
...
2. Reference `particle/docs/specs/REGISTRY_OF_REGISTRIES.md`
...
# AI query
python wave/tools/ai/analyze.py "question" --set brain
