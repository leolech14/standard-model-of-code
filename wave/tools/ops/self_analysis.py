...
sys.path.append(os.path.join(project_root, "particle"))
sys.path.append(os.path.join(project_root, "particle/src/core"))
...
def run_self_analysis():
    ...
    src_path = os.path.abspath("particle/src/core")
    ...
    # Now fill the stubs
    docs_root = Path("particle/docs/core")
