...
OUTPUTS:
    ...
    - wave/data/intel/spiral/spiral_state.json (state + lap stats)
    - wave/data/intel/spiral/lap_history.json (detailed lap records)
    - wave/data/intel/spiral/unified_model.json (export)
...
INTEL_DIR = PROJECT_ROOT / "wave" / "data" / "intel"
