...
PROJECT_ROOT = Path(__file__).parent.parent.parent.parent  # up 3 levels: tools/maintenance/ -> tools/ -> wave/ -> PROJECT_ROOT
...
def load_timestamps():
    ...
    if not TIMESTAMPS_FILE.exists():
        print(f"Error: {TIMESTAMPS_FILE} not found. Run wave/tools/maintenance/update_timestamps.sh first.")
        sys.exit(1)
