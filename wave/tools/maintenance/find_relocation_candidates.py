...
METADATA_CSV = PROJECT_ROOT / "wave/output/file_metadata_audit.csv"
...
def analyze_clusters(files):
    ...
    clusters['docs_in_code'] = {
        ...
        'suggestion': 'Move to docs/ directory or wave/docs/',
    ...
    clusters['orphan_agent'] = {
        ...
        'suggestion': 'Consider consolidating under wave/.agent/',
    ...
    clusters['scattered_configs'] = {
        ...
        'suggestion': 'Consider consolidating under wave/config/',
    ...
    clusters['output_scattered'] = {
        ...
        'suggestion': 'Move to wave/output/ or project-specific output/',
