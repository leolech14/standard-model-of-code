...
|------------|------------------------|----------------------|---------------|
| PARTICLE   | particle/| Analyze structure    | Deterministic |
| WAVE       | wave/    | Understand semantics | Probabilistic |
...
1. `particle/docs/theory/L0_AXIOMS.md` - Foundational axioms
2. `particle/docs/theory/L1_DEFINITIONS.md` - Definitions including Three Realms
3. `particle/src/core/level_classifier.py` - L-scale implementation
