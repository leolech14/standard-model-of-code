...
Output: wave/intelligence/boundaries.json
...
ANALYSIS_SETS_PATH = PROJECT_ROOT / "wave/config/analysis_sets.yaml"
OUTPUT_DIR = PROJECT_ROOT / "wave/intelligence"
...
def create_boundary_node(
    ...
    return {
        ...
        "type": "boundary",
        "name": name,
        "source_path": "wave/config/analysis_sets.yaml",
