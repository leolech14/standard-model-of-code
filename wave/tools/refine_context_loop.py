...
COLLIDER_SCRIPT = PROJECT_ROOT / "particle/src/core/full_analysis.py"
LOG_DIR = PROJECT_ROOT / "wave/intelligence/logs"
ANALYSIS_TOOL = PROJECT_ROOT / "wave/tools/ai/analyze.py"
...
def run_collider():
    ...
    try:
        ...
        # Set PYTHONPATH to include particle
        env = os.environ.copy()
        env["PYTHONPATH"] = str(PROJECT_ROOT / "particle") + os.pathsep + env.get("PYTHONPATH", "")
