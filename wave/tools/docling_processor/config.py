...
DEFAULT_INPUT_DIR = PROJECT_ROOT / "wave/library/references/pdf"
DEFAULT_OUTPUT_DIR = PROJECT_ROOT / "wave/library/references/docling_output"
DEFAULT_CONFIG_PATH = PROJECT_ROOT / "wave/config/docling_config.yaml"
