...
Usage:
    from wave.tools.docling_processor import DoclingProcessor, DoclingConfig
...
CLI:
    python -m wave.tools.docling_processor process
    python -m wave.tools.docling_processor status
"""
