...
| **Lint** | `cd particle && ruff check src/` |
| **Format** | `cd particle && black src/ --check` |
| **Build** | `cd particle && pip install -e .` |
...
| Tool docs | `particle/docs/COLLIDER.md` |
| Constants SSoT | `particle/schema/constants.yaml` |
| AI analysis | `wave/tools/ai/analyze.py` |
