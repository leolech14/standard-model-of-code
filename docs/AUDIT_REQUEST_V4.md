...
**Location**: [STANDARD_MODEL_PAPER.md#21-units-and-mappings](STANDARD_MODEL_PAPER.md#21-units-and-mappings)
...
**Code**: 
- `../data/LAW_11_CANONICAL.json` - 11 canonical antimatter laws
...
*Standard Model of Code - V4 Audit Request*
