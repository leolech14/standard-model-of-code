# 96 Hadrons — Granular Particle Catalog (Standard Model v4)

> **Context:** This dataset provides the granular 96-item taxonomy referenced by the "Codex" agents. It is a **Composite Model** (Structure + Role) which has been superseded by the orthogonal v5 **8D Model** (Atoms + Roles).
>
> **Use Case:** Use this file to understand the "1440 Validation Grid" and legacy constraints. Do NOT use for new code classification (use `200_ATOMS.md` and `roles.json` instead).

**Status:** Historical Reference & Validation Logic Source.
