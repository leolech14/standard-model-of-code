...
Output:
    context-management/data/intel/zoo_comparisons/
...
THEORY_DIR = PROJECT_ROOT / "standard-model-of-code" / "docs" / "theory"
CODE_ZOO_PATH = THEORY_DIR / "CODE_ZOO.md"
SWEBOK_PATH = PROJECT_ROOT / "context-management" / "archive" / "references" / "swebok" / "swebok-v4-clean.txt"
OUTPUT_DIR = PROJECT_ROOT / "context-management" / "data" / "intel" / "zoo_comparisons"
