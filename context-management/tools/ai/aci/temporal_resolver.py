...
class TemporalResolver:
    ...
    def query_code_count(self, code_file: str, concept: str) -> Dict:
        ...
        return {
            ...
            'note': 'Run: python context-management/tools/ai/analyze.py --file {code_file} "<query>"'
        }
...
if __name__ == "__main__":
    ...
    result = resolver.resolve_conflict(
        ...
        files=[
            ...
            "standard-model-of-code/docs/specs/REGISTRY_OF_REGISTRIES.md"
        ],
        code_source="standard-model-of-code/src/core/pipeline/stages/__init__.py"
    )
