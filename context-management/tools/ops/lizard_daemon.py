...
# Configuration
CODE_ROOT = Path("standard-model-of-code/src/core").resolve()
DOC_ROOT = Path("standard-model-of-code/docs/core").resolve()
    ...
    try:
        while True:
            ...
            if modified:
                ...
                try:
                    # Run Self-Analysis
                    cmd = [sys.executable, "context-management/tools/ops/self_analysis.py"]
