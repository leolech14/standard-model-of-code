...
Examples:
    ...
    python -m context_management.tools.docling validate

    # Process single file
    python -m context_management.tools.docling process --file paper.pdf

    # Process all PDFs
    python -m context_management.tools.docling process

    # Resume failed batch
    python -m context_management.tools.docling resume --batch latest

    # Check status
    python -m context_management.tools.docling status

    # Export chunks
    python -m context_management.tools.docling export-chunks --batch latest
        """
    )
