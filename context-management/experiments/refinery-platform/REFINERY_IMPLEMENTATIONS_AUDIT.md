...
```
Location: context-management/archive/intelligence/legacy/
Status: Old, archived
```
...
```
Location: context-management/archive/
...
```
Location: standard-model-of-code/archive/legacy_experiments/
...
**Before deciding:**
1. Run `cd context-management/viz/unified-dashboard && npm install && npm run dev`
...
ln -s /Users/lech/PROJECTS_all/PROJECT_elements/context-management/viz/unified-dashboard \
      ~/refinery-dashboard
