...
|----------|----------|-----------|
| L0_AXIOMS.md | standard-model-of-code/docs/theory/ | Source of collision |
| FUNDAMENTAL_INSIGHT_L_SCALE_SCOPE.md | context-management/docs/theory/ | Discovery document |
| POSITIONING.md | context-management/tools/docsintel/ | DocsIntel analysis |
| level_classifier.py | standard-model-of-code/src/core/ | Code using L-scale |
...
- Decision → copy to `standard-model-of-code/docs/adr/`
