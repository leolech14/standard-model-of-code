...
- Subsystem: S14 created in context-management/tools/ai/graph_rag/
...
### New:
- `context-management/tools/ai/graph_rag/` - S14 subsystem
...
- `context-management/tools/refinery/` - Query + reports
- `context-management/tools/ai/` - S14 GraphRAG
...
**Implementation:**
- context-management/tools/ai/graph_rag/*.py (S14)
