...
```python
# NEW FILE: context-management/tools/ai/aci/executors/gemini_executor.py
...
```python
# NEW FILE: context-management/tools/ai/aci/executors/perplexity_executor.py
...
```
Reads:
- context-management/config/research_schemas.yaml (workflow definitions)
- context-management/config/analysis_sets.yaml (context sets)

Writes:
- standard-model-of-code/docs/research/perplexity/ (auto-save)
- standard-model-of-code/docs/research/gemini/ (auto-save)
```
...
1. Create `context-management/tools/ai/aci/executors/` directory
