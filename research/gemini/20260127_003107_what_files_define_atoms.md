...
**File:** `particle/schema/atoms.json`
...
**File:** `particle/src/patterns/particle_defs.json`
...
| :--- | :--- | :--- |
| **Schema** | `particle/schema/atoms.json` | Full list of 167 Atoms (JSON) |
| **Code** | `particle/src/core/atom_registry.py` | 94 Implemented Atoms (Python) |
| **Rules** | `particle/src/patterns/particle_defs.json` | Detection Logic (JSON) |
| **Theory** | `particle/docs/MODEL.md` | Concepts & Definitions (Markdown) |
