# Research: List ALL documentation collections: specs directories, research outputs, reports, guides. For each c...

> **Date:** 2026-01-25 08:14:06
> **Source:** gemini
> **Model:** gemini-3-pro-preview
> **Checksum:** `sha256:d6ac33a9249b11e04e302b26380983ede5503cd6ef7dd389d195a59ee6917271`
> **Raw JSON:** `raw/20260125_081406_list_all_documentation_collections__specs_director.json`

---

## Query

List ALL documentation collections: specs directories, research outputs, reports, guides. For each collection: name, path, file count, what topics they cover.
...
*   **Topics Covered:**
    ...
    *   **Usage:** The Collider CLI tool manual, commands, and troubleshooting.
...
*   **Topics Covered:**
    ...
    *   **Refactoring Plans:** Detailed plans for modularizing `app.js` and frontend systems.
    *   **Fact Checking:** Reconciliations of conflicting claims across documentation versions.
...
*   **Topics Covered:**
    ...
    *   **Investigations:** Atom coverage studies, network centrality analysis, and context window optimization.
