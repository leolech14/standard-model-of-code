...
1.  Access the document: wave/docs/theory/THEORY_AXIOMS.md to fetch the core elements of the foundational structure.
2.  Extract from what is provided about that framework
3.  Format for the user request",
    "action": "Extracting information and providing the requested summary based on content from 'wave/docs/theory/THEORY_AXIOMS.md'."
  },
  "answer": {
